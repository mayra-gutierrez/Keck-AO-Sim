...
keck_telescope = keckTel.create('keck', resolution=160, samplingTime=1/1000)
...
# Instantiate the Haka DM
haka_dm = keckDm.create(keck_telescope.tel, 'haka')
...
print(f"Haka DM pitch: {haka_dm.dm.pitch * 1e3} mm")
