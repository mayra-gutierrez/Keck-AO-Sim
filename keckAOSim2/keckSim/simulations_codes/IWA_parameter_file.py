...
def initializeParameterFile():
    ...
    param['windSpeed'            ] = np.array([6.8, 6.9, 7.1, 7.5, 10.0, 26.9, 18.5])                         # wind speed of the different layers in [m.s-1]
    ...
    ###%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PWFS PROPERTIES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    param['nSubaperture'         ] = 60    	# number of SHWFS subaperture along the telescope diameter
    param['nPixel_separation'    ] = 4     	# sampling of the PWFS subapertures
    param['nPixel_edge'          ] = 2     	# pixel scale in arcsec
    param['shannon'              ] = False
    param['lightThreshold'       ] = 0.5   	# light threshold to select the valid pixels
    param['modulation'         	 ] = 0 		# post-processing of the PWFS signals 
    param['postProcessing'       ] = 'fullFrame_incidence_flux'   # COG threshold
    param['binning'              ] = 1     	# binning of the detctor
    
    ###%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% TELESCOPE PROPERTIES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    
    param['diameter'             ] = 10.95  # diameter in [m]
    param['resolution'           ] = param['nSubaperture']*6    # resolution of the telescope driven by the PWSF
    ...
    ###%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% M1 aberrations %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    param['M1_segments_pistons' ] = False    # piston of the segments
    param['M1_segments_tilts'   ] = False    # tilts of the segments
    param['M1_OPD_amplitude'    ] = 125*1e-9 # M1 OPD amplitude in [nm] RMS

    param['warping_M1'		] = False	# warping aberration for the segments
    param['warped_ampplitude'	] = 66 * 1e-9	# amplitude of the Warping from the PCS data     
    ...
    param['NCPA_amplitude'      ] = 125*1e-9    # NCPA amplitude in [nm] RMS
    param['NCPA_nmin'           ] = 5           # minimum radial order of the Zernike modes
    param['NCPA_nmax'           ] = 15          # maximum radial order of the Zernike modes
    
    param['Pure_NCPA_amplitude'	] = 0*1e-9	# Pure NCPA in science
    param['Pure_NCPA_nmin'     	] = 5
    param['Pure_NCPA_nmax'	] = 15
    ...
    param['Jitter_amp'          ] = 0.3         # Jitter oscillation around 30nmRMS
    ...
    param['opticalBand_guide'    ] = 'H'    # optical band of the guide star
    ...
    ###%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% DM PROPERTIES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    param['nActuator'            ] = 56+1  # number of actuators 
    ...
    param['nModes'               ] = 300            # number of controlled modes  
    ...
    ###%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Reconstructor %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    param['alpha'	         ] = 1e15 #1e13 xin and 1e15 HAKA
    param['eps_iMat'	         ] = 0
    param['weight_power'         ] = 1.0
    ...
    param['nLoop'               ] = 100     # number of iteration                             
    ...
    param['ZWFS_algo'           ] = None                                  # algo for the ZWFS loop JPL by default
    param['ZWFS_luckyImg'	] = True				  # Lucky Imaging
    param['keepFraction'	] = 0.2				          # fraction of frames to keep
    param['center_r'		] = 32                                    # pixels radius central obs
    ...
    param['pathOutput'] = '/home/mcisse/keckAOSim/keckSim/data/sync/'
