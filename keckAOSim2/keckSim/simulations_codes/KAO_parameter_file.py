...
def initializeParameterFile():
    ...
    param['resolution'           ] = 336    #280 if SH 20x20   # resolution of the telescope driven by the SHWFS
    ...
    ###%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% NCPA aberrations %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    param['NCPA'                ] = True        # to enable NCPA
    ...
    ###%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% SH PROPERTIES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    param['nSubaperture'         ] = 56    # number of SHWFS subaperture along the telescope diameter
    ...
    param['stroke'               ] = 100*1e-9                  # stroke to calibrate the DM in [m]
    ###%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  MODAL BASIS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    param['modal_basis'          ] ='KL'       # name of the basis
    param['nModes'               ] = 500            # number of controlled modes  
    ...
    param['type_rec'            ] = 'zonal'  # reconstructor type
    ...
    param['pathInput'] = '/Users/mayragutierrez/home/lab/maygut/keckAOSim2/keckSim/data/'
    param['pathOutput'] = '/Users/mayragutierrez/home/lab/maygut/keckAOSim2/keckSim/data/sync/'
