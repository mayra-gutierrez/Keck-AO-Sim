...
def initializeParameterFile():
    ...
    ###%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Jitter %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    param['Jitter'              ] = True        # to enable Jitter
    param['Jitter_amp'          ] = 0.3         # Jitter amp if 1 : 100nm RMS
    param['Jitter_freq'         ] = 30          # Jitter frequency in Hz
    param['Jitter_nFrames'      ] = 1000        # Jitter nFrames
    ...
    param['nModes'               ] = 500     # number of KL modes controlled 
    param['SVD_thr'              ] = 2
    param['modal_trunc'          ] = 0
    ...
    param['nLoop'               ] = 400     # number of iteration                             
